          ...
          <div className="flex flex-col gap-8 items-center justify-start w-full">
            ...
            <div className="flex flex-col items-center justify-start w-full">
              <div className="gap-10 md:gap-5 grid md:grid-cols-1 grid-cols-2 justify-center min-h-[auto] w-full">
                <div className="bg-deep_purple-400 border-2 border-deep_purple-400 border-solid flex flex-1 flex-col gap-6 items-start justify-start p-4 rounded-lg w-full">
                  <div className="flex flex-col items-center justify-start mt-2 w-[36%] md:w-full">
                    <div className="flex flex-row gap-2 items-end justify-start w-full">
                      <Img
                        className="h-10 w-10"
                        src="images/img_groupsblack24dp_white_a700.svg"
                        alt="groupsblack24dp"
                      />
                      <Text
                        className="mb-0.5 mt-[7px] text-white-A700 text-xl"
                  ...
                  <Text
                    className="mb-2 text-sm text-white-A700 w-full"
